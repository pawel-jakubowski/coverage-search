...
class PerspectiveCameraLeft : public CPerspectiveCameraEquippedEntity {
public:
    ...
    virtual std::string GetTypeDescription() const override {
        return "perspective_camera_left";
    }
};

class PerspectiveCameraRight : public CPerspectiveCameraEquippedEntity {
public:
    using CPerspectiveCameraEquippedEntity::CPerspectiveCameraEquippedEntity;
    virtual std::string GetTypeDescription() const override {
        return "perspective_camera_right";
    }
};
...
static const int PERSPECTIVE_CAMERA_HEIGHT  = 1;
static const int PERSPECTIVE_CAMERA_WIDHT  = 900;

/****************************************/
/****************************************/

CCustomFootBotEntity::CCustomFootBotEntity() :
...
CCustomFootBotEntity::CCustomFootBotEntity(const std::string& str_id,
    ...
    try {
        ...
        m_pcLeftPerspectiveCameraEquippedEntity =
            new PerspectiveCameraLeft(this,
                                      ...
                                      cPerspLeftCamAnchor);
        m_pcRightPerspectiveCameraEquippedEntity =
            new PerspectiveCameraRight(this,
                                       "perspective_camera_right_0",
                                       c_perspcam_aperture,
                                       f_perspcam_focal_length,
                                       f_perspcam_range,
                                       PERSPECTIVE_CAMERA_WIDHT,
...
void CCustomFootBotEntity::Init(TConfigurationNode& t_tree) {
    try {
        /*
         * Init parent
         */
...
void CCustomFootBotEntity::Reset() {
...
void CCustomFootBotEntity::UpdateComponents() {
...
REGISTER_ENTITY(CCustomFootBotEntity,
                "custom-foot-bot",
...
REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CCustomFootBotEntity);
